    ...
    juegos.forEach(juego => {
        html += `
            <tr>
                ...
                <td>$${juego.price}</td>
                <td class="d-flex" >
                    <a class="mx-2 btn btn-primary" href="/juegos/${juego.appid}" >Ver</a>
                    <a class="mx-2 btn btn-warning" href="/juegos/editar/${juego.appid}" >editar</a>
                    <a class="mx-2 btn btn-danger" href="/juegos/eliminar/${juego.appid}" >borrar</a>
                </td>
            </tr>
            `
    });
